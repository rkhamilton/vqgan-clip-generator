...
```sh
conda create --name vqgan python=3.9 pip numpy==1.20.3 pytest tqdm=4.62.3 git pytorch==1.9.0 torchvision=0.10.0 torchaudio=0.9.0 cudatoolkit=11.1 -c pytorch -c conda-forge
conda install -c conda-forge ffmpeg=4.2.2
conda install ipykernel=6.4.1
conda activate vqgan
pip install git+https://github.com/openai/CLIP.git taming-transformers==0.0.1 ftfy==6.0.3 regex==2021.9.30 pytorch-lightning==1.4.9 kornia==0.5.11 imageio==2.9.0 omegaconf==2.1.1 torch-optimizer==0.1.0 piexif==1.1.3
