...
final_output_filename = os.path.join('example media', 'restyled video.mp4')
copy_audio = True
...
generated_video_frames_path = f'example media{os.sep}video frames'
...
if upscale_images:
    upscaled_video_frames_path = f'example media{os.sep}upscaled video frames'
